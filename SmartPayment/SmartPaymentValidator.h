...
// The SmartPaymentValidator class helps with SPD validation.

@interface SmartPaymentValidator : NSObject
...
// Returns list of all errors identified during the validation.
- (NSArray*) errors;
- (NSError*) firstError;
